...
public final class ForkedChannelEncoder
{
    ...
    public void stdOut( String msg, boolean newLine )
    {
        ...
        setOutErr( event.getOpcode(), msg == null ? "null" : msg );
    }
    ...
    {
        StringBuilder event = print( BOOTERCODE_CONSOLE_INFO.getOpcode(), runMode.geRunName(), msg );
        encodeAndPrintEvent( event );
    }

    public void error( String msg )
    {
        StringBuilder event = print( BOOTERCODE_CONSOLE_ERROR.getOpcode(), runMode.geRunName(), msg );
        encodeAndPrintEvent( event );
    }
    ...
    {
        StringBuilder encoded = encodeHeader( BOOTERCODE_CONSOLE_ERROR.getOpcode(), runMode.geRunName() );
    ...
    {
        StringBuilder event = print( BOOTERCODE_CONSOLE_DEBUG.getOpcode(), runMode.geRunName(), msg );
        encodeAndPrintEvent( event );
    }

    public void warning( String msg )
    {
        StringBuilder event = print( BOOTERCODE_CONSOLE_WARNING.getOpcode(), runMode.geRunName(), msg );
        encodeAndPrintEvent( event );
    }
     ...
     */
    StringBuilder print( String operation, String runMode, String... msgs )
    {
        ...
        return encodeMessage( operation, runMode, encodedMsgs );
    }

    static StringBuilder encodeMessage( String operation, String runMode, String... msgs )
    {
