...
public final class ForkedChannelDecoder
{
    ...
    public void setStdOutNewLineListener( ForkedProcessStandardOutErrEventListener listener )
    {
    ...
    public void setStdErrNewLineListener( ForkedProcessStandardOutErrEventListener listener )
    {
