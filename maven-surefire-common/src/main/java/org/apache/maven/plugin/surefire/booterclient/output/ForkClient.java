     ...
     implements StreamConsumer
{
                       ...
                       ConsoleLogger log, AtomicBoolean printedErrorStream, int forkNumber )
    {
        ...
        StdOutListener stdOut = new StdOutListener();
        decoder.setStdOutListener( stdOut );
        decoder.setStdOutNewLineListener( stdOut );
        StdErrListener stdErr = new StdErrListener();
        decoder.setStdErrListener( stdErr );
        decoder.setStdErrNewLineListener( stdErr );
