    ...
    extends TestCase
{
        ...
        throws ReporterException, IOException
    {
        ...
        forkStreamClient.consumeMultiLineContent( ":maven:surefire:std:out:normal-run:sys-prop:UTF-8:azE=:djE="
                + "\n:maven:surefire:std:out:normal-run:sys-prop:UTF-8:azI=:djI=" );
